...
Why do the vast majority of StackOverflow users only post once? This study
found that “less active users” are more likely to: not have questions answered, 
get negative feedback (or answers that can be interpreted that way), self-answer
their own questions and less likely to have questions not already answered.
